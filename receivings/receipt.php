...
<div id="receipt_wrapper">
	...
	<table id="receipt_items">
		<tr>
			...
			<th style="width:20%;"><?php echo $this->lang->line('sales_quantity'); ?> /Ton</th>
		...
		?>
			<tr>
				...
				<td><div class="total-valsales_quantityue"><?php echo to_currency($item['total']*$item['receiving_quantity']); ?></div></td>
			</tr>
			<tr>
